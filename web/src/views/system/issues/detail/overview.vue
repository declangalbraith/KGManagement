		...
		<div class="kg-issue-detail__grid">
			<div class="kg-issue-detail__main">
				...
				<IssueGantt
					...
					@manage="router.push(`/issues/${issueId}/tasks`)"
			...
			<aside class="kg-issue-detail__side">
				...
				<section class="kg-card">
					...
					<div class="kg-card__body kg-quick">
						<button type="button" class="kg-quick__item" @click="router.push(`/issues/${issueId}/rca`)">
							<span class="kg-quick__icon is-primary"><el-icon><Search /></el-icon></span>
							<span>{{ t('message.pages.issues.rca') }}</span>
						</button>
						<button type="button" class="kg-quick__item" @click="router.push(`/issues/${issueId}/8d`)">
...
<script setup lang="ts" name="kg-issues-detail-overview">
import { ref } from 'vue';
