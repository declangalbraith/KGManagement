...
<template>
    <el-drawer :append-to-body="false" title="条件设置" v-model="visible" class="condition_copyer" :show-close="false" :size="550" :before-close="saveCondition"> 
        ...
        <div class="demo-drawer__content">
            <div class="condition_content drawer_content">
                        ...
                        <div v-if="item.type==1">
                            <p :class="conditionConfig.nodeUserList.length > 0?'selected_list':''" @click.self="addConditionRole" style="cursor:text">
                                <span v-for="(item1,index1) in conditionConfig.nodeUserList" :key="index1">
                                    {{item1.name}}<span class="kg-wf-remove" @click="$func.removeEle(conditionConfig.nodeUserList,item1,'targetId')"></span>
                                </span>
                ...
                <el-dialog title="选择条件" v-model="conditionVisible" :width="480" :append-to-body="false" class="condition_list">
...
import { optTypes, opt1s } from '../../utils/const.js'
...
let store = useWorkflowDesignerStore()
