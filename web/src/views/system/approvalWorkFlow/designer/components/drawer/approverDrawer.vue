<template>
    <el-drawer :append-to-body="false" title="审批人设置" v-model="visible" class="set_promoter" :show-close="false" :size="550" :before-close="saveApprover"> 
                ...
                <div class="approver_content">
                    ...
                    <p class="selected_list" v-if="approverConfig.settype==1">
                        <span v-for="(item,index) in approverConfig.nodeUserList" :key="index">{{item.name}}
                            <span class="kg-wf-remove" @click="$func.removeEle(approverConfig.nodeUserList,item,'targetId')"></span>
                        </span>
...
import { setTypes, selectModes, selectRanges } from '../../utils/const.js'
