...
-->
<template>
    <el-drawer :append-to-body="false" title="抄送人设置" v-model="visible" class="set_copyer" :show-close="false" :size="550" :before-close="saveCopyer"> 
            ...
            <div class="copyer_content drawer_content">
                ...
                <p class="selected_list">
                    <span v-for="(item,index) in copyerConfig.nodeUserList" :key="index">{{item.name}}
                        <span class="kg-wf-remove" @click="$func.removeEle(copyerConfig.nodeUserList,item,'targetId')"></span>
                    </span>
